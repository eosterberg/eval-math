// JavaScript Grammar / limited to numbers
// ==================
// Modified copy of: https://github.com/peggyjs/peggy/blob/f5781ba72a700dc6605f32cd0609a4ae48164fa1/examples/javascript.pegjs
//
...
NullLiteral
  = NullToken { throw new Error("Null literals not supported."); return { type: "Literal", value: null }; }

BooleanLiteral
  = TrueToken  { throw new Error("Boolean literals not supported use '1' instead."); return { type: "Literal", value: true  }; }
  / FalseToken { throw new Error("Boolean literals not supported use '0' instead."); return { type: "Literal", value: false }; }
...
StringLiteral "string"
  = '"' chars:DoubleStringCharacter* '"' {
      throw new Error("String literals not supported.");
...
RegularExpressionLiteral "regular expression"
  = "/" pattern:$RegularExpressionBody "/" flags:$RegularExpressionFlags {
      throw new Error("Regular expressions not supported");
...
PrimaryExpression
  = ThisToken { throw new Error("This expression not supported."); return { type: "ThisExpression" }; }
  / Identifier
  / Literal
  / ArrayLiteral
  / ObjectLiteral
...
ObjectLiteral
  = "{" __ "}" { throw new Error("Object expressions not supported."); return { type: "ObjectExpression", properties: [] }; }
  / "{" __ properties:PropertyNameAndValueList __ "}" {
       throw new Error("Object expressions not supported.");
